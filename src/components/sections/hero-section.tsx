    ...
    >
      ...
      <div className="relative mx-auto flex w-full max-w-3xl flex-col items-center justify-center px-4 py-28 text-center sm:px-6 sm:py-32 lg:px-8">
        <motion.div
          ...
          className="relative"
        >
          <div className="pointer-events-none absolute -inset-6 rounded-full bg-bf-gold/15 blur-3xl" />
          <motion.div
            animate={{ y: [0, -10, 0] }}
        ...
        >
          ...
          <MagneticButton
            ...
            className="inline-flex h-13 w-full items-center justify-center gap-2 rounded-full border border-bf-gold/40 bg-bf-gold/10 px-8 text-base font-semibold text-bf-gold backdrop-blur-sm sm:w-auto"
          >
            Contact Us
          </MagneticButton>
          <MagneticButton
